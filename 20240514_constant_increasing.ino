...
unsigned long increase_period = 35000; // Increase period in milliseconds
...
void loop() {
  ...
  if (digitalRead(50) == HIGH) {
    // Use the analog input to set potDC1
    ...
    potDC1 = 20 + progress * 80; // Gradually increase from 20 to 100
  }
